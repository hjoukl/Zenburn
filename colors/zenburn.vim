...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    " modified from original zenburn for better matching parentheses visibility
    hi MatchParen    guifg=#f0f0c0 guibg=#383838 gui=bold  ctermfg=229 ctermbg=12 cterm=bold
    ...
    " modified from original zenburn for better matching parentheses visibility
    hi MatchParen    guifg=#b2b2a0 guibg=#2e2e2e gui=bold  ctermfg=188 ctermbg=12  cterm=bold
